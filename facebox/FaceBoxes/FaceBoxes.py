...
from facebox.FaceBoxes.utils.prior_box import PriorBox
from facebox.FaceBoxes.utils.nms_wrapper import nms
from facebox.FaceBoxes.utils.box_utils import decode
from facebox.FaceBoxes.utils.timer import Timer
from facebox.FaceBoxes.utils.functions import check_keys, remove_prefix, load_model
from facebox.FaceBoxes.utils.config import cfg
from facebox.FaceBoxes.models.faceboxes import FaceBoxesNet
...
pretrained_path = make_abs_path('../FaceBoxes/weights/FaceBoxesProd.pth')
...
class FaceBoxes:
    ...
    def __call__(self, img_):
        ...
        img = torch.from_numpy(img).unsqueeze(0).to(device=self.device)
