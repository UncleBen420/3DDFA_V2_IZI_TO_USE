...
import facebox.models as models
from facebox.bfm import BFMModel
from facebox.utils.io import _load
from facebox.utils.functions import (
    crop_img, parse_roi_box_from_bbox, parse_roi_box_from_landmark,
)
from facebox.utils.tddfa_util import (
...
class TDDFA(object):
    ...
    def __init__(self, **kvs):
        ...
        model = load_model(model, make_abs_path('weights/mb1_120x120.pth'))
